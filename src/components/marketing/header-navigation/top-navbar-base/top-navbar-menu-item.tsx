...
interface TopNavbarMenuItemLinkProps {
    href: string;
...
export const TopNavbarMenuItemLink = ({ href, icon: Icon, iconClassName, title, badge, subtitle, className, actionsContent }: TopNavbarMenuItemLinkProps) => (
    <a
        href={href}
        className={cx(
